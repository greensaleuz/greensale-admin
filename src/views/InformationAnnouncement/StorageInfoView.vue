src/views/InformationAnnouncement/SellerInfoView.vue<script lang="ts">
...
export default defineComponent({
  ...
  methods: {
    async getDataAsync() { 
      ...
      var response = await axios.get<SellersPostByIdViewModel[]>('/api/common/seller/post/'+this.Id)
