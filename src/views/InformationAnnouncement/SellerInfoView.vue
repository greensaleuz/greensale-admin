...
<label class="px-2 py-1 mb-1 text-sm text-gray-700 border border-gray-200 rounded-lg  bg-gray-50 dark:text-gray-300  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400">{{ $t('fullname') }}: {{ fullName }}</label>
