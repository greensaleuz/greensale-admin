        ...
        <ul class="py-2 font-medium" role="none">
          <li>
            <button
              ...
              class="w-40 items-start block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white"
              role="menuitem"
            >
